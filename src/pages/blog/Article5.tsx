...
const Article5 = () => {
  useEffect(() => {
    ...
    const url = origin + '/blog/manage-100-pdfs-at-once';
    const keywords = [
    ...
    const ld: any[] = [
      {
        ...
        '@type': 'BlogPosting',
        headline: 'How to Manage 100 PDFs at Once Without Losing Your Mind',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Manage 100 PDFs at Once', item: url }
        ]
      }
    ];
        ...
        <article className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="mb-10 p-5 rounded-lg border border-border bg-card">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1">
              <li>Think in patterns and batches, not individual files.</li>
              <li>Use Excel to plan actions; execute them all at once.</li>
              <li>Break mega-batches into sub-batches to stay sane and accurate.</li>
              <li>Back up, test small, and then scale for predictable success.</li>
            </ul>
          </div>
